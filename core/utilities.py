...
def listen_data_changed_event_async(connection: Redis, prev_image_cache: PrevImageCache, source_cache: dict, smart_vision_cache: dict):
    def fn():
        while 1:
            event_bus = None
            try:
                ...
                handler.smart_vision_cache.set_dict(smart_vision_cache)
